...
public interface SteamAuthenticationService {
  ...
  // public boolean validateSessionTicket(String sessionTicket, String steamId, String expectedSteamId); //티켓 (파트너계정) 임시 주석처리
   ...
   void linkSteamAccount(String userId, String steamId, String steamNickname,  boolean isSteamLinked);   // 기존 사용자 계정에 Steam 계정을 연동하는 메서드
